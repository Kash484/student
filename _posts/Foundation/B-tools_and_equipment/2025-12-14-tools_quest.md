...
![Github Account]({{site.baseurl}}/images/about/github_account.png)

Step 2: Set Up Windows
Since I'm on a Windows laptop, I got familiar with Terminal. It's basically where I run all my commands to set up projects and manage code. Windows works really well for development tools, which made things easier.

![Setup Windows Ubuntu Terminal]({{site.baseurl}}/images/about/terminal.png)
...
![Forked Student Repository]({{site.baseurl}}/images/about/repository.png)

Step 5: Clone to Local Computer
I cloned both repositories to my Windows so I could work on them locally. They're organized in my documents folder where I can easily access them.

Step 6: Virtual Environment Setup
For each project, I run source venv/bin/activate to create a virtual environment, then source venv/bin/activate to activate it. This keeps all my project dependencies separate and organized. After that, I type code . to open everything in VS Code.
